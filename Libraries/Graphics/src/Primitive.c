...
/////////////////////// LOCAL FUNCTIONS PROTOTYPES ////////////////////////////
    ...
    void 	PutImage24BPP(SHORT left, SHORT top, FLASH_BYTE *image, BYTE stretch, PUTIMAGE_PARAM *pPartialImageData);
...
/**
  ...
  * @retval
  */
void __attribute__((weak)) PutImage24BPP(SHORT left, SHORT top, FLASH_BYTE *image, BYTE stretch, PUTIMAGE_PARAM *pPartialImageData)
{
    register FLASH_DWORD *flashAddress;
    WORD                sizeX, sizeY;
    register WORD       x, y;
    WORD                xc, yc;
    DWORD               temp;
    ...
    // Move pointer to size information
    flashAddress = (FLASH_DWORD *)image;

    // Read image size
    sizeY = (*flashAddress & 0xFFFF0000) >> 16;
    flashAddress++;
    sizeX = *flashAddress & 0xFFFF;
    flashAddress++;
        ...
        case (XFLASH | COMP_NONE):
            ...
            switch(colorDepth)
            {
                ...
                case 16:    
					...
					#if (COLOR_DEPTH == 24)
                case 24:
                	PutImage24BPP(left, top, flashAddress, stretch, &partialImage); break;
					#endif
